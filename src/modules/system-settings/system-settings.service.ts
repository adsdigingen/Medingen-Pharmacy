...
export class SystemSettingsService {
  ...
  async update(dto: UpdateSettingsDto) {
    ...
    return this.repo.updateSingleton({
      storeName:
        dto.storeName !== undefined ? dto.storeName : settings.storeName,
      ...
      printerType:
        dto.printerType !== undefined ? dto.printerType : settings.printerType,
      backupInterval:
        dto.backupInterval !== undefined
          ? dto.backupInterval
          : settings.backupInterval,
      defaultOfflineMarkup:
        dto.defaultOfflineMarkup !== undefined
          ? dto.defaultOfflineMarkup
          : settings.defaultOfflineMarkup,
      defaultOnlineMarkup:
        dto.defaultOnlineMarkup !== undefined
          ? dto.defaultOnlineMarkup
          : settings.defaultOnlineMarkup,
      defaultGst:
        dto.defaultGst !== undefined ? dto.defaultGst : settings.defaultGst,
      defaultRetailDiscount:
        dto.defaultRetailDiscount !== undefined
          ? dto.defaultRetailDiscount
          : settings.defaultRetailDiscount,
    });
  }
}
